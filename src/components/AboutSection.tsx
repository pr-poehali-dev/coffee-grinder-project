        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl font-bold text-coffee-dark mb-6 font-montserrat">
              О кофейне Coffee Grinder Челябинск
            </h2>
            <p className="text-lg text-gray-700 mb-6">
              ...
              в сердце Челябинска. Наша миссия — делиться любовью к
              качественному кофе с каждым нашим клиентом.
            </p>
            <p className="text-lg text-gray-700 mb-8">
              ...
              Бразилии и других кофейных регионов. Свежая обжарка прямо в
              Челябинске.
            </p>
